...
//  Original
//  public function modificar_personas00000() {
//    $p = new Personas();
//    $p->consulta_basica();
...
//        $consulta = "UPDATE personas SET cod_persona='" . $this->cod_persona . "', nombre='" . $this->nombre . "', apellidos='" . $this->apellidos . "', pais='" . $this->pais . "' WHERE cod_persona='" . $this->cod_persona2 . "';";
...
//  }
//  Buscamos modificar el cod_persona
