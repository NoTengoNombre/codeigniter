...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2017 a las 20:17:29
...
INSERT INTO `paises` (`id_paises`, `pais`, `ciudad`) VALUES
(1, 'Spain', 'Madrid'),
(2, 'France', 'Paris'),
(2, 'France', 'Paris'),
(3, 'Germany', 'Berlin'),
...
INSERT INTO `peliculas` (`id_video`, `id_usuario`, `titulo`, `duracion`, `estreno`, `sinopsis`, `genero`, `tipo`, `formato`, `enlace`, `imagen`) VALUES
(1, 2, 'fight club', '120', 1999, 'pelicula divertida', 'comedia', 1, 'dvd', 'www.ejemplo.com', 'a');
...
(2, 'pepe', '1993-11-04', 'Jaen', 'Hombre', 'c', 'pepe@gmail.com', 'Canta en la ducha', 'pepe', 0),
(3, 's', '2016-12-13', 's', 's', 's', 's', 's', 's', 0),
(5, 'f', '2017-01-04', 'add', 'asdasd', 'adasd', 'adda', 'asdas', 'r', 0);
