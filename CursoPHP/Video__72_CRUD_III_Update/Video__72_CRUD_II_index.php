...
<html>
  ...
  <body>
    ...
    <?php
    include 'Video__72_CRUD_II_conexion.php';
    ...
    <table width="50%" border="0" align="center">
      ...
      <?php foreach ($registros as $persona): ?>
        <tr>
          ...
          <td class="bot"><a href="Video__72_CRUD_II_borrar.php?Id=<?php echo $persona->Id ?>">
              <input type="button" name="del" id="del" value="Borrar">
            </a></td>
          <td class="bot">
            <a href="Video__72_CRUD_II_editar.php?Id=<?php echo $persona->Id ?> 
