  ...
  <body>
    ...
    if ($_FILES['imagen']['error']) {
      ...
      if ((isset($_FILES['imagen']['name']) && ($_FILES['imagen']['error'] == UPLOAD_ERR_OK))) {
        $destino_de_ruta = "Video__96_imagenes/";
...
//    cambiar el campo por la informacion que viene del formulario 
    ...
    <a href="Video__96_Creacion_Blog_Formulario_.php">Añadir nueva entrada</a>

    <a href="Video__96_Creacion_Blog_Mostrar_Blog.php">Ver Mostrar Blog</a>
  </body>
</html>
