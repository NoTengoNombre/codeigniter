...
{
    case 'index':
        $view->clientes=Cliente::getClientes(); // trae todos los clientes
        $view->contentTemplate=true;
        /*$view->client=new Cliente();
        $view->contentTemplate=true;
        $view->label='Autentifica';
    ...
    case 'logIn':
        ...
        $view->label='Autentifica';
        $view->disableLayout=true;
        $view->contentTemplate="templates/clientLog.php"; // seteo el template que se va a mostrar
        break;
